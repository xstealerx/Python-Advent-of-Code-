class Bruch:
  ...
  # Mit dieser Methode soll potenziert werden können.  
  def __pow__(self,exponent):
    # Zähler und Nenner werden mithilfe des Exponenten "exponent" potenziert. 
    return Bruch(self.zähler**exponent,self.nenner**exponent)
